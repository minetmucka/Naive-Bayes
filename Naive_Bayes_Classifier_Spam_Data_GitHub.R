...
## Please install "klaR" package: install.packages("klaR") for Classification and Visualization                                                              #
## Please install "ElemStatLearn" package: install.packages("ElemStatLearn") for Elements of Statistical Learning, data mining, inference, and prediction   #
#############################################################################################################################################################
